...
import {AuthState, getAuthState, getError, getUser, isAuthLoading, isUserLogged} from './lib/reducers/user.reducer';
...
export {AuthState, Credentials, IUser, User, getAuthState, isAuthLoading, isUserLogged, getUser, getError};
